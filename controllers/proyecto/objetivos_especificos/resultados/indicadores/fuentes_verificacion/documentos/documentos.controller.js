...
exports.findAll = function (req, res, next) {
    ...
    const objetivo = proyecto.objetivos_especificos.id(req.params.objetivo_especifico_id);
    const resultado = objetivo.resultados.id(req.params.resultado_id);
    const indicador = resultado.indicadores.id(req.params.indicador_id);
